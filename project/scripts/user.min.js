...
exports.Effects = exports.StatsDictionary = exports.Outfit = exports.Equipment = exports.Character = void 0;
...
function createItemLookups() {
  ...
  window.gm.ItemsLib['Leggings'] = {
    name: 'Sport-Leggings',
    desc: 'Spandex-leggings for sport.',
    tags: ['cloth'],
    slotUse: ['Legs'],
    canEquip: defaultCanUse,
    canUnequip: defaultCanUnequip
  };
  window.gm.ItemsLib['Tank-shirt'] = {
    name: 'White Tank-shirt',
    desc: 'White Tank-shirt.',
    tags: ['cloth'],
    slotUse: ['Torso', 'Arms'],
    canEquip: defaultCanUse,
    canUnequip: defaultCanUnequip
  };
  window.gm.ItemsLib['Jeans'] = {
    name: 'Bluejeans',
    desc: 'Thight fitting blue jeans.',
    tags: ['cloth'],
    slotUse: ['Legs'],
    canEquip: defaultCanUse,
    canUnequip: defaultCanUnequip
  };
  window.gm.ItemsLib['Pullover'] = {
    name: 'Pullover',
    desc: 'A warm pulloer.',
    tags: ['cloth'],
    slotUse: ['Torso', 'Arms'],
  ...
  window.gm.ItemsLib['Crowbar'] = {
    name: 'Crowbar',
    desc: 'A durable crowbar.',
    tags: ['tool', 'weapon'],
    slotUse: ['RHand'],
...
window.storage = {
  ...
  rebuildFromSave: function rebuildFromSave(hash) {
    window.story.restore(hash); //Reconnect the objects! 
...
window.gm.initGame = function (forceReset) {
  ...
  if (!s.player || forceReset) {
    ...
    s.player.name = 'You', s.player.skillPoints = 2, //no. of free skillpoints on game-start
    //perklevels ,name should match perkId
    s.player.skSporty = 0, s.player.skCook = 0, s.player.skSlacker = 0, s.player.skMoneymaker = 0, s.player.skTechy = 0, window.gm.player = new Character(s.player); //add some basic inventory
...
function canConsumeCoffee(context) {
  return {
    OK: true,
    msg: 'drinkable'
  };
...
function onUseCoffee(context) {
  ...
  return {
    OK: true,
    msg: 'you gulped down a can of iced coffee'
  };
    ...
    value: function use(context) {
      if (context instanceof Inventory) {
        ...
        if (context.parent instanceof Character) {
          context.parent.addEffect('CanOfCoffee:Energized', window.gm.EffectLib.Energized); //context.parent.gainStat('energy',10);
...
var Character = /*#__PURE__*/function () {
  ...
  _createClass(Character, [{
    ...
    key: "gainStat",
    value: function gainStat(id, val) {
...
var StatsDictionary = /*#__PURE__*/function (_Inventory) {
  ...
  var _super5 = _createSuper(StatsDictionary);
  ...
  function StatsDictionary(owner, externlist) {
    ...
    return _super5.call(this, owner, externlist);
  }
  ...
  _createClass(StatsDictionary, [{
    ...
    key: "addModifier",
    value: function addModifier(id, modifier) {}
  }, {
    key: "removeModifier",
    value: function removeModifier(id, modifier) {} //override
...
var stFitness = /*#__PURE__*/function () {
  function stFitness() {
    _classCallCheck(this, stFitness);
  }

  _createClass(stFitness, null, [{
    key: "setup",
    value: function setup(context, base, max) {
...
var Effects = /*#__PURE__*/function (_Inventory2) {
  ...
  var _super6 = _createSuper(Effects);

  //Todo a collection of Stats is similiar to Inventory?
  function Effects(owner, externlist) {
    _classCallCheck(this, Effects);

    return _super6.call(this, owner, externlist);
  } //override
...
var effEnergized = /*#__PURE__*/function (_Effect) {
  ...
  var _super7 = _createSuper(effEnergized);
...
var effNotTired = /*#__PURE__*/function (_Effect2) {
  ...
  var _super8 = _createSuper(effNotTired);
...
var effTired = /*#__PURE__*/function (_Effect3) {
  ...
  var _super9 = _createSuper(effTired);
  ...
  _createClass(effTired, null, [{
    ...
    key: "onTimeChange",
    value: function onTimeChange(context, data, time) {//-10 max energy after 12h, but only up to 3 times
    }
  }, {
    key: "onApply",
    value: function onApply(context, data) {
