...
window.gm.calcAttack = function (enemysTurn) {
  ...
  var att = attacker.Stats.get('pAttack').value; //GURPS-Lite ?
...
var Character = /*#__PURE__*/function () {
  ...
  function Character(externlist) {
    ...
    stHealth.setup(this.Stats, 50, 60), stEnergy.setup(this.Stats, 30, 100), stPAttack.setup(this.Stats, 4, 100), stPDefense.setup(this.Stats, 4, 100), stAgility.setup(this.Stats, 4, 100), stStrength.setup(this.Stats, 4, 100), stEndurance.setup(this.Stats, 4, 100);
  ...
  _createClass(stStrength, null, [{
    ...
    value: function updateModifier(context) {
      context.addModifier('healthMax', {
        id: 'strength',
        bonus: context.get('strength').value
      });
...
var stEndurance = /*#__PURE__*/function () {
  ...
  _createClass(stEndurance, null, [{
    ...
    value: function updateModifier(context) {
      context.addModifier('healthMax', {
        id: 'endurance',
        bonus: context.get('endurance').value
      });
