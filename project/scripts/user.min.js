...
var Character = /*#__PURE__*/function () {
  ...
  function Character(externlist) {
    ...
    stHealth.setup(this.Stats, 50, 60), stEnergy.setup(this.Stats, 30, 100), stPAttack.setup(this.Stats, 10, 100), stPDefense.setup(this.Stats, 10, 100), stAgility.setup(this.Stats, 10, 100), stStrength.setup(this.Stats, 10, 100), stEndurance.setup(this.Stats, 10, 100);
