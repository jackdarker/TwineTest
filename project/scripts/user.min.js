...
exports.Effects = exports.StatsDictionary = exports.Outfit = exports.Pullover = exports.TankShirt = exports.Jeans = exports.Leggings = exports.Equipment = exports.Character = void 0;
...
var Leggings = /*#__PURE__*/function (_Equipment) {
  ...
  function Leggings() {
    ...
    _this5.tags = ['cloth'];
    _this5.slotUse = ['Legs'];
    _this5.desc = 'Spandex-leggings for sport. (Fitness+)';
    return _this5;
  }
  ...
  _createClass(Leggings, [{
    ...
    key: "onEquip",
    value: function onEquip(context) {
      context.parent.Stats.addModifier('fitness', {
        id: 'fitness:Leggings',
        bonus: 5
      });
      return {
    ...
    key: "onUnequip",
    value: function onUnequip(context) {
      context.parent.Stats.removeModifier('fitness', {
        id: 'fitness:Leggings'
      });
      return {
        OK: true,
...
var StatsDictionary = /*#__PURE__*/function (_Inventory) {
  ...
  var _super9 = _createSuper(StatsDictionary);
  ...
  function StatsDictionary(owner, externlist) {
    ...
    return _super9.call(this, owner, externlist);
  }
...
var stFitness = /*#__PURE__*/function () {
  ...
  _createClass(stFitness, null, [{
    ...
    value: function setup(context, base, max) {
      ...
      _n.id = 'fitness', _n.base = base, _n.value = base, _n.modifys = [{
        id: 'healthMax'
      }];
      if (context.findItemSlot(_n.id) < 0) context.list.push(_n);
...
var Effects = /*#__PURE__*/function (_Inventory2) {
  ...
  var _super10 = _createSuper(Effects);
...
var effEnergized = /*#__PURE__*/function (_Effect) {
  ...
  var _super11 = _createSuper(effEnergized);
...
var effNotTired = /*#__PURE__*/function (_Effect2) {
  ...
  var _super12 = _createSuper(effNotTired);
...
var effTired = /*#__PURE__*/function (_Effect3) {
  ...
  var _super13 = _createSuper(effTired);
